        ...
        >
          {modes.map((mode) => (
            <motion.div
              ...
              className="group relative overflow-hidden rounded-3xl border border-border bg-surface shadow-soft p-6 sm:p-7"
            >
              ...
              <div className="relative">
                ...
                <div className="mt-7">
                  <a
                    href="#start"
                    className="inline-flex items-center gap-1.5 rounded-full bg-accent text-accent-fg shadow-btn px-5 py-2.5 text-sm font-semibold transition-transform group-hover:translate-x-0.5"
                  >
                    {mode.cta}
