...
export const SCENARIOS: Scenario[] = [
  ...
  },
  {
    ...
    "userGoal": "Get your roommate to agree to fair limits and a share of the costs for their partner's near-constant presence — without it turning into a fight about the relationship itself."
  },
  {
    "id": "tough-feedback",
    "emoji": "🗣️",
    ...
    "userGoal": "Get Devon to genuinely own the missed deadlines and commit to a concrete change — without them shutting down or blaming everyone else."
  },
  {
    "id": "parent-boundary",
    "emoji": "👪",
    ...
    "userGoal": "Hold a clear boundary about the unannounced visits and the criticism — while making sure she leaves feeling loved rather than rejected.",
    "difficulty": "hard"
  },
  {
    "id": "breakup",
    ...
    "userGoal": "End the relationship honestly and compassionately — leaving Sam with clarity and dignity, and without offering any false hope you don't actually mean."
  },
  {
    "id": "vendor-refund",
    "emoji": "🧾",
